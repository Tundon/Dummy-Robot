...
public:
    ...
    auto MakeProtocolDefinitions()
    {
        return make_protocol_member_list(
            ...
            make_protocol_ro_property("position_y", &this->currentPose6D.Y),
            make_protocol_ro_property("position_z", &this->currentPose6D.Z),
            make_protocol_ro_property("position_a", &this->currentPose6D.A),
            make_protocol_ro_property("position_b", &this->currentPose6D.B),
            make_protocol_ro_property("position_c", &this->currentPose6D.C),
